...
const zone = argv.env && argv.env.ZONE ? argv.env.ZONE : 'public';

const userConfig = merge(desire(`${__dirname}/../${zone}/config`), desire(`${__dirname}/../${zone}/config-local`));

const isProduction = !!((argv.env && argv.env.production) || argv.p);
const rootPath = (userConfig.paths && userConfig.paths.root)
  ? userConfig.paths.root
  : process.cwd() + (userConfig.paths && userConfig.paths.subfolder ? userConfig.paths.subfolder : '');
