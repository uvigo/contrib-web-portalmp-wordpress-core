	...
	public function widget( $args, $instance ) {
		...
		<form action="<?php echo esc_url( $blog_url ); ?>" class="widget-filter__form" method="get">
			<div class="widget-filter__search">
				<input type="search" class="form-control" placeholder="Introduce palabras..." value="<?php echo $f_text; ?>" name="s">
				<button type="submit" class="btn" data-icon="U"><span class="sr-only">Buscar</span></button>
			</div>
			<?php if ( $dates || $taxonomies ) : ?>
				<div class="widget-filter__title">Filtrar por:</div>
			<?php endif; ?>
			<?php if ( $dates ) : ?>
				...
				foreach ( $wp_taxonomies as $wp_taxonomy ) {
					if ( in_array( $wp_taxonomy->name, $taxonomies ) ) {
						...
						<div class="widget-filter__block">
							...
							<div id="<?php echo esc_attr( $wp_taxonomy->name ); ?>" class="widget-filter__content widget-filter__taxonomy">
